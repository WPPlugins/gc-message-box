<?php
    ...
    $GC_Message_Box_Config = array(
        'GCHOME' => 'http://getconversion.com',
        'GCPLUGINHOME' => 'http://getconversion.com/products/gc-message-box',
        'GCSERVICES' => 'http://services.getconversion.net',
        'GCFORUM' => 'http://community.getconversion.net/forum/gc-message-box',
        'GCROADMAP' => 'http://community.getconversion.net/roadmap/gc-message-box',
        'GCIDEA' => 'http://community.getconversion.net/idea',
        'GCBUG' => 'http://community.getconversion.net/bug',
        'MYGC' => 'http://my.getconversion.net',
        'WPORGURL' => 'http://wordpress.org/plugins/gc-message-box/',
