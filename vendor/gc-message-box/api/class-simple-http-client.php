<?php
if(class_exists("Gc_MessageBox_Simple_HTTP_Client")){
    return;
}
class Gc_MessageBox_Simple_HTTP_Client implements Gc_MessageBox_Http_Client_Interface{
    ...
    public function get_response(){
        $url = $this->get_url();
        $request = Gc_MessageBox_CF::create("Http_Request");
