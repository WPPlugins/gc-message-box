<?php
if(class_exists("Gc_MessageBox_Abstract_Renderer")){
    return;
}
abstract class Gc_MessageBox_Abstract_Renderer{
    protected $namespace;
    ...
    protected function get_repository_factory(){
        return Gc_MessageBox_CF::create("Option_Repository_Factory");
    }
    ...
    public function get_event_manager(){
      if($this->event_manager == null){
        $this->event_manager = Gc_MessageBox_CF::create_and_init("Event_Manager",array("global" => true, "namespace"=> "get_conversion"));
      } 
