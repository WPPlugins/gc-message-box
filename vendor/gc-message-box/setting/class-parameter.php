<?php
if(class_exists("Gc_MessageBox_Setting_Parameter")){
    return;
}
class Gc_MessageBox_Setting_Parameter 
extends 
    Gc_MessageBox_Setting_Parameter_Base
implements 
    Gc_MessageBox_Configurable_interface,
    Gc_MessageBox_Storable_Interface,
    Gc_MessageBox_Serializable_Interface,
    Gc_MessageBox_Option_Type_Detection_Interface
{

    /* #REGION Gc_MessageBox_Configurable_interface*/
    ...
    /* #REGION Gc_MessageBox_Storable_Interface */
    ...
    public function get_store_engine_instance(){
        if(Gc_MessageBox_Service_Locator::has($this->store_engine)){
            return Gc_MessageBox_Service_Locator::get($this->store_engine);
        };

        return Gc_MessageBox_CF::create("Option_Store");
    }
    /* #ENDREGION */

    /* #REGION Gc_MessageBox_Serializable_Interface*/
    ...
    /* #REGION Gc_MessageBox_Option_Type_Detection_Interface*/
