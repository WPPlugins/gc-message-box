<?php
if(class_exists("Gc_MessageBox_Setting_Parameter_Base")){
    return;
}
class Gc_MessageBox_Setting_Parameter_Base 
implements
        Gc_MessageBox_Testable_Interface    
{
    /* #REGION $id */
    protected $id ="";
    ...
    /* #REGION Gc_MessageBox_Testable_Interface */
    /* #REGION $variant */
