<?php
if(class_exists('Gc_MessageBox_Setting_Resultset')) {
    return;
}

class Gc_MessageBox_Setting_Resultset
implements
    ...
    Gc_MessageBox_Serializable_Interface
{
    ...
    protected function configure_parameters($parameters){
        foreach ($parameters as $key => $param) {
            ...
            if(is_array($param)){
                $this->parameters[$key] = Gc_MessageBox_CF::create_and_init("Setting_Parameter", $param);
            }else{
...
//                $filtered_options[$key] = $opt->export_to_array(true);
        ...
        return Gc_MessageBox_CF::create_and_init("Setting_Resultset", $config);
    }
