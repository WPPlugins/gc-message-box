...
class Gc_MessageBox_Event_Manager 
implements
    Gc_MessageBox_Configurable_Interface
{
    ...
    public function configure(array $options){
        ...
        $this->store = new Gc_MessageBox_Registry();
    ...
    public function dispatch($event, Gc_MessageBox_Event $event_data,$before_after_event_call = false){
