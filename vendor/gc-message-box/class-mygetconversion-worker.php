<?php
if(class_exists("Gc_MessageBox_Mygetconversion_Worker")){
    return;
}
class Gc_MessageBox_Mygetconversion_Worker{
        ...
        public function add_handler($name,Gc_MessageBox_Remote_Action_Interface $handler){
        ...
        public function execute($request){
            ...
            try{
                ...
                $request_params = Gc_MessageBox_CF::create_and_init("Request",$params);
        ...
        protected function send_global_worker_output(){
            global $GC_Mygetconversion_Worker;            
            $_output_formatter = Gc_MessageBox_CF::create("Remote_Action_Output_Json");
