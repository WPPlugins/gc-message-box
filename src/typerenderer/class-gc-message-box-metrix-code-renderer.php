<?php
if(class_exists("Gc_MessageBox_Metrix_Code_Renderer")){
    return;
}

class Gc_MessageBox_Metrix_Code_Renderer extends Gc_MessageBox_Abstract_Renderer{
        ...
        jQuery(document).ready(function(){
            jQuery('#connect-to-mygc').click(function(){
                jQuery('body').popBox({
                    ...
                    content : 'iframe',
                    contentUrl : 'admin-ajax.php?action=gc-message-box-mygc-signin',
