...
if(class_exists("Gc_MessageBox_RoleFilter_Renderer")){
    return;
}

class Gc_MessageBox_RoleFilter_Renderer extends Gc_MessageBox_Abstract_Renderer{
    protected $type = "";
    ...
    public function render($description) {
        ...
        <div class="item <?php echo $this->type; /* . " " . $this->get_descriptor_param("css_class"); */ ?>" id="<?php echo $description->get_name(); ?>_cnt" <?php if(!$description->is_visible()){ echo 'style="display:none"';}?>>
            ...
            <?php foreach($this->states as $id => $state){
                ...
                <div class="ad">
                    <div class="wooblock">
                        <a href="<?php echo $GC_Message_Box_Config['GCSERVICES']; ?>/gc-message-box/woothemes/woocommerce" target="_blank">
                            <i>Compatible with</i>
                            <b></b>
                            <div class="clear"></div>
                        </a>
                    ...
                    <div class="woolinkblock">
                        <a href="<?php echo $GC_Message_Box_Config['GCSERVICES']; ?>/gc-message-box/woothemes/woocommerce" target="_blank">Get WooCommerce</a> <u>or</u> <a href="<?php echo $GC_Message_Box_Config['GCSERVICES']; ?>/gc-message-box/woothemes/woocommerce" target="_blank">Learn more</a>
                    </div>
                </div>
            </div> 
