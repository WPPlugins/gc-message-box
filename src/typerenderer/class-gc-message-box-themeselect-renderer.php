<?php
if(class_exists("Gc_MessageBox_Themeselect_Renderer")){
    return;
}

class Gc_MessageBox_Themeselect_Renderer extends Gc_MessageBox_Abstract_Renderer{
    ...
    public function render($description) {
        $this->all_options = Gc_MessageBox_CF::create("Option_Repository_Factory")->get_instance()->get_namespace($description->get_namespace());
                ...
                GC.MessageBox = {
                    ...
                    changeColors : function (set) {
                        ...
                        <?php } ?>
                            ...
                            GC.MessageBox.shadows();
                    }

                }
                jQuery(document).ready(function(){
                    jQuery("#<?php echo $this->option->get_name(); ?>_input").change(function() {
                        GC.MessageBox.changeColors(GC.MessageBox.sets[jQuery("#<?php echo $this->option->get_name(); ?>_input option:selected").val()]);
                    });
                });
        </script>
        <?php
