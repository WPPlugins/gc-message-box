<?php
if(class_exists("Gc_MessageBox_GroupFilter_Group_Renderer")){
    return;
}

class Gc_MessageBox_GroupFilter_Group_Renderer extends Gc_MessageBox_Abstract_Renderer{
	public $list = array();
	public $groups = array();
	...
	public function render($description) {
		...
		if(!is_plugin_active('groups'.DIRECTORY_SEPARATOR .'groups.php')) {
			...
			<div class="noplugin">
				...
				This function requires Groups plugin. You can dowload it from here: <a href="<?php echo $GC_Message_Box_Config['GCSERVICES']; ?>/gc-message-box/groups" target="_blank">Groups</a>
			</div>
			<?php
			return false;
		}
