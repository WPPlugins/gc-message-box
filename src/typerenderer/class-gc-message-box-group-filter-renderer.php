...
if(class_exists("Gc_MessageBox_GroupFilter_Renderer")){
    return;
}

class Gc_MessageBox_GroupFilter_Renderer extends Gc_MessageBox_Abstract_Renderer{
    protected $type = "";
            ...
            <?php foreach($this->states as $id => $state){
                ...
                <div class="ad">
                    ...
                    <div class="woolinkblock">
                        <a href="<?php echo $GC_Message_Box_Config['GCSERVICES']; ?>/gc-message-box/woothemes/groups-for-woocommerce" target="_blank">How to start with Groups</a>
                    </div>
                </div>
            </div> 
