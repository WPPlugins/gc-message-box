<?php
if(class_exists("Gc_Message_Box_Options_Compose_Container_Renderer")){
	return;
}
class Gc_Message_Box_Options_Compose_Container_Renderer extends Gc_MessageBox_Options_Group_Container_Renderer{
