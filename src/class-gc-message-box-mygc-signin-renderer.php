<?php
if(class_exists("Gc_Message_Box_MyGC_Signin_Renderer")){
	return;
}
class Gc_Message_Box_MyGC_Signin_Renderer extends Gc_MessageBox_Abstract_Renderer{
	...
	public function render($params) {
        ...
        <link href="http://fonts.googleapis.com/css?family=Roboto:400,700,300" media="screen" rel="stylesheet" type="text/css">
        <link href="http://fonts.googleapis.com/css?family=Roboto+Condensed:400,700,300" media="screen" rel="stylesheet" type="text/css">
        <link href="http://fonts.googleapis.com/css?family=Bitter:400,700" media="screen" rel="stylesheet" type="text/css">
        <link href="<?php echo plugins_url('gc-message-box/css/mygc-connect.css') ?>" rel="stylesheet" type="text/css" />
        <?php if($params['section'] === 'signin'): ?>
        <div class="loginwrapper">
            <h2>Connect To MY.GetConversion</h2>
            <form action="admin-ajax.php?action=gc-message-box-mygc-signin" method="POST">
