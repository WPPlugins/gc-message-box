<?php
if(class_exists("Gc_MessageBox_Engine_Options_Group_Container_Renderer")){
    return;
}
class Gc_MessageBox_Options_Engine_Group_Container_Renderer extends Gc_MessageBox_Container_Renderer{
    ...
    public function __construct($group_descriptor,$items,$namespace){
        ...
        $this->state_option =  Gc_MessageBox_CF::create_and_init(
          "Option",
          array(
